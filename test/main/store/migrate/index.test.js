...
describe('migration 23', () => {
  ...
  it('sets the icon value on a chain', () => {
    ...
    expect(chains[10].icon).toBe('https://cdn.lightpay.tech/icons/optimism.svg')
    expect(chains[42].icon).toBe('')
    expect(chains[100].icon).toBe('https://cdn.lightpay.tech/icons/gnosis.svg')
    expect(chains[137].icon).toBe('https://cdn.lightpay.tech/icons/polygon.svg')
    expect(chains[8888].icon).toBe('')
    expect(chains[42161].icon).toBe('https://cdn.lightpay.tech/icons/arbitrum.svg')
