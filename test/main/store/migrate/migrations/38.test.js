...
// ---------------------------------------------------------------------------
// Provider RPC removal
// ---------------------------------------------------------------------------

describe('provider RPC removal', () => {
...
// ---------------------------------------------------------------------------
// Pylon / custom RPC edge cases
// ---------------------------------------------------------------------------

describe('Pylon and custom RPC edge cases', () => {
...
describe('migration warning flag', () => {
...
describe('chain validity', () => {
  ...
  it('should keep a valid non-migrated chain in the state', () => {
    ...
    expect(updatedState.main.networks.ethereum['1']).toStrictEqual(expected)
  })

  describe('edge cases', () => {
    it('should produce no ethereum chains when starting from an empty networks object', () => {
      const updatedState = migration.migrate(state)

      expect(Object.keys(updatedState.main.networks.ethereum)).toHaveLength(0)
    })
  })
})
