...
describe('device detection', () => {
  ...
  describe('edge cases', () => {
    it('emits no events when no devices are connected or disconnected', () => {
      const addSpy = jest.fn()
      const removeSpy = jest.fn()

      adapter.on('add', addSpy)
      adapter.on('remove', removeSpy)
...
// ---------------------------------------------------------------------------
// Eth app reconnection (per platform)
// ---------------------------------------------------------------------------

describe('eth app reconnection', () => {
