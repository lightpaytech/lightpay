...
describe('sentry', () => {
  describe('#beforeSend', () => {
    ...
    const sampleException = {
      type: 'Error',
      value:
        'Cannot find latest.yml in the latest release artifacts (https://github.com/lightpay-labs/lightpay/releases/download/v0.5.0-beta.20/latest.yml): HttpError: 404 \n"method: GET url: https://github.com/lightpay-labs/lightpay/releases/download/v0.5.0-beta.20/latest.yml\\n\\...',
      stacktrace: {
        frames: [
          {
            module:
              'C:\\Users\\RickyBobby\\AppData\\Local\\Programs\\lightpay\\resources\\app.asar\\node_modules\\electron-updater\\out\\AppUpdater'
          },
          { module: 'node:domain' },
          {
            module:
              'C:\\Users\\RickyBobby\\AppData\\Local\\Programs\\lightpay\\resources\\app.asar\\compiled\\main\\signers\\lattice\\Lattice\\index'
          }
        ]
      }
    }
    ...
    const validEvent = {
      ...
      tags: {
        'lightpay.instance_id': undefined
      },
      user: {
      ...
      const linuxException = {
        ...
        stacktrace: {
          frames: [
            {
              module:
                '/home/RickyBobby/.config/lightpay/resources/app.asar/node_modules/electron-updater/out/AppUpdater'
            },
            { module: 'node:domain' },
            {
              module:
                '/home/RickyBobby/.config/lightpay/resources/app.asar/compiled/main/signers/lattice/Lattice/index'
            }
          ]
        }
      }
