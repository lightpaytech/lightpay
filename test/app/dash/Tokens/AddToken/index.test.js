...
describe('setting token details', () => {
  ...
  it('should populate fields with token data', async () => {
    ...
    const mockToken = { name: 'LightPay Test on Polygon', symbol: 'mFRT', decimals: 18, totalSupply: '1066' }
    ...
    expect(contractAddressInput.textContent).toEqual('0x64aa3364D7e7f1D4')
    await waitFor(() => expect(tokenNameInput.value).toEqual('LightPay Test on Polygon'), { timeout: 200 })
