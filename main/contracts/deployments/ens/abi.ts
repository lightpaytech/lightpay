// Named constants for ABI entry types and state mutability labels
const ABI_TYPE_EVENT = 'event'
const ABI_TYPE_FUNCTION = 'function'
const ABI_TYPE_CONSTRUCTOR = 'constructor'
const ABI_STATE_VIEW = 'view'
const ABI_STATE_NONPAYABLE = 'nonpayable'
const ABI_STATE_PAYABLE = 'payable'
const ABI_STATE_PURE = 'pure'
