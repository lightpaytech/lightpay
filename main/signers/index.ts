...
// Hardware wallet adapters disabled pending Electron upgrade - using hot wallets only
...
const registeredAdapters: SignerAdapter[] = []
// Hardware wallets disabled: [new LedgerAdapter(), new TrezorAdapter(), new LatticeAdapter()]
