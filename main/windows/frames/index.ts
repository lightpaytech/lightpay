// LightPay windows run dapps and other functionality
...
function getFrames(): Record<string, LightPay> {
...
export default class FrameManager {
  ...
  manageFrames(frames: Record<string, LightPay>, inFocus: string) {
  ...
  manageViews(frames: Record<string, LightPay>) {
    const frameIds = Object.keys(frames)
