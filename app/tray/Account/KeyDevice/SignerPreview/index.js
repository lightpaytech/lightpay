...
class Signer extends React.Component {
    ...
    if (type === 'lattice') {
      return (
        <div className='moduleItemSignerType'>
          <div className='sectionItemIcon'>{svg.lattice(18)}</div>
          <div>{'GridPlus'}</div>
        </div>
      )
    } else if (type === 'ledger') {
      return (
        <div className='moduleItemSignerType'>
          <div className='sectionItemIcon'>{svg.ledger(16)}</div>
          <div>{'Ledger'}</div>
        </div>
      )
    } else if (type === 'trezor') {
      return (
        <div className='moduleItemSignerType'>
          <div className='sectionItemIcon'>{svg.trezor(15)}</div>
          <div>{'Trezor'}</div>
        </div>
      )
      ...
      return (
        <div className='moduleItemSignerType'>
          <div className='sectionItemIcon'>{svg.flame(16)}</div>
          <div>{'Hot'}</div>
        </div>
      )
    } else {
      return (
        <div className='moduleItemSignerType'>
          <div className='sectionItemIcon'>{svg.mask(20)}</div>
          <div>{'Watch-only'}</div>
        </div>
      )
    }
  ...
  getCurrentStatus(activeSigner, hardwareSigner) {
    ...
    return (
      <div className='dataGroupTag' style={style}>
        {status}
      </div>
    )
  }
  ...
  render() {
    ...
    return (
      <div className='assetsBlock' ref={this.moduleRef}>
