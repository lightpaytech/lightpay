...
// import ProviderRequest from './AccessFlow'
// import TransactionRequest from './TxFlow'
// import SignatureRequest from './SigFlow'
// import ChainRequest from './NetworkFlow'
// import AddTokenRequest from './TokenAddFlow'
// import SignTypedDataRequest from './TypedSignFlow'

import TxOverview from './TxFlow/TxMainNew/overview'
...
class Requests extends React.Component {
      ...
      <ClusterBox key={origin}>
        <div className='requestGroup'>
          ...
          <div className='requestGroupMain'>
            ...
            <div className='actionGroupLabel'>{groupName}</div>
          </div>
          <div
        ...
        <Cluster>
          ...
          {requests.map((req, i) => {
            if (req.type === 'access') {
              ...
              } = this.store('main.networksMeta.ethereum', networkId)
  ...
  renderExpanded() {
    ...
    return (
      <div className='walletViewScroll' style={{ paddingTop: '40px' }}>
        {groups.length === 0 ? (
