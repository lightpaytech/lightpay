      ...
      <div className='assetsBlock' ref={this.moduleRef}>
        <div className='sectionTitle'>
          ...
          {existingChains.length > 1 && (
            <div className='networkMonitorSwitch'>
              <div className='networkSwitchBtn' onClick={() => this.setIndex(this.state.index - 1)}>
        ...
        <Cluster>
          <Monitor address={address} networkId={currentChain.id} color={`var(--${primaryColor})`} />
        </Cluster>
      </div>
    )
  }
