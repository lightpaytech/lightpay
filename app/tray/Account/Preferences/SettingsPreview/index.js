        ...
        <div className='assetsBlock'>
          <Cluster>
            <ClusterRow>
              ...
              >
                <div className='sectionItem'>{this.state.showMore ? 'less' : 'more'}</div>
              </ClusterValue>
            </ClusterRow>
            {this.state.showMore ? (
              <>
                {this.state.editName ? (
                  <ClusterRow>
                    <ClusterValue pointerEvents={true}>
                      <div key={'input'} className='sectionItem vaultCardShow moduleItemInput'>
                  ...
                  <ClusterRow>
                    ...
                    >
                      <div className='sectionItem vaultCardShow'>{'Update Name'}</div>
                    </ClusterValue>
                  </ClusterRow>
                )}
                <ClusterRow>
                  ...
                  >
                    <div className='sectionItem vaultCardShow'>{'Remove Account'}</div>
                  </ClusterValue>
                </ClusterRow>
              </>
            ) : null}
