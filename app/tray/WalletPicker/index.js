...
class AccountSelector extends React.Component {
  ...
  renderAccountFilter() {
    ...
    return (
      <div className='walletSearchMain'>
          ...
          {displayAccounts.length ? (
            ...
            <ClusterBox style={{ pointerEvents: 'auto' }}>
              <Cluster>
                <ClusterRow>
                  <ClusterValue>
                    <div className='noDevices'>{'No Wallets Yet'}</div>
                  </ClusterValue>
                </ClusterRow>
                <ClusterRow>
                  <ClusterValue
                  ...
                  >
                    <div className='addWalletBtn'>
                      ...
                      <div className='newAccountText'>{'Create New Wallet'}</div>
                    </div>
                  </ClusterValue>
                </ClusterRow>
              </Cluster>
            ...
            <div className='noDevices'>{'No Matching Wallets'}</div>
          )}
        </div>
      </div>
    )
  ...
  render() {
    ...
    return (
      <div className={open ? 'walletSelector walletSelectorOpen' : 'walletSelector'}>
