...
class RequestCommand extends React.Component {
  ...
  sentStatus() {
    ...
    const chain = {
      type: 'ethereum',
      id: parseInt(req.data.networkId, 'hex')
    }
  ...
  infoPane() {
    ...
    const info = {
      sign: 'When LightPay is waiting for your signer to sign this transaction',
      send: 'When LightPay is broadcasting this transaction to your selected endpoint',
      block: 'When LightPay is waiting for this transaction to be included into a block'
    }
  ...
  renderPopBar() {
    ...
    return (
      <div
        className={
          req.automaticFeeUpdateNotice ? 'autoGasUpdate autoGasActive' : 'autoGasUpdate'
        }
      >
