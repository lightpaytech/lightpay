    ...
    <div className='notify vaultCardShow'>
      <div className='alertWrap' onMouseDown={(e) => e.stopPropagation()}>
        <div className='alertBoxSlide'>
          <ClusterBox>
            <NotifyTop>
              <div style={{ color: 'var(--bad)' }}>{svg.firefox(40)}</div>
            </NotifyTop>
            <Cluster>
              <ClusterRow>
                <ClusterValue>
                  <NotifyMain>
                    <div style={{ paddingBottom: '24px' }}>
                      {`A new ${browserName} extension is attempting to connect as "LightPay Companion"`}{' '}
                    </div>
                    <div>{`If you did not recently add LightPay Companion please verify the extension origin below`}</div>
                  </NotifyMain>
                </ClusterValue>
              </ClusterRow>
              <ClusterRow>
