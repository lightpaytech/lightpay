...
const originFilter = ['lightpay-internal', 'lightpay-extension']
...
class Dapps extends React.Component {
  ...
  render() {
    ...
    const { lpAppDetails } = this.props.data

    if (lpAppDetails) {
      return <DappDetails originId={lpAppDetails} />
    } else {
      return (
        <div className='vaultCardShow' style={{ padding: '0px 0px 64px 0px' }}>
