            ...
            <>
              {state !== 'exited' ? (
                <>
                  ...
                  />
                  <div
                    className={state === 'entered' ? 'addAccountMain addWalletMainActive' : 'addAccountMain'}
                  >
                    <div className='addAccountMainInner'>
                      <div className='addWalletTitle'>Add Account</div>
                      <div className='addAccountBreak' />
                      <div className='addWalletSubtitle'>
                        Add or create a decentralized account to use with any dapp
                      </div>
                      <div className='addAccountBreak' />
                      <div className='addWalletHeader'>
