...
const TokenError = ({ text, onContinue }) => {
  return (
    <div className='newTokenView vaultCardShow'>
              ...
              return (
                  ...
                  onClick={() => {
                    ...
                    setTimeout(() => {
                      link.send('tray:action', 'navDash', {
                        ...
                        data: {
                          notify: 'addAsset',
                          notifyData: { chain: { id: networkId, color: primaryColor, name: chain.name } }
                        }
                      })
                    }, 200)
                  }}
                >
                  <div className='originChainItemIcon'>
                    <RingIcon
                      color={primaryColor ? `var(--${primaryColor})` : 'var(--bad)'}
                      img={icon}
                      small={true}
                    />
                  </div>
...
const EnterAddress = ({ chain }) => {
  ...
  const { name: networkName, color } = chain
...
const TokenDetailsForm = ({ req, chain, tokenData, isEdit }) => {
  ...
  const saveAndClose = () => {
    ...
    link.send('tray:addAsset', token, req)
  ...
  return (
    <div className='alertWrap vaultCardShow' onMouseDown={(e) => e.stopPropagation()}>
      <div className='alertBoxSlide'>
        <div className='addAssetTop'>
          <div className='addAssetTitle' data-testid='addTokenFormTitle'>
        ...
        <div className='addAsset'>
          ...
          <div className='tokenRow'>
            {newTokenReady ? (
              ...
              <div role='button' className='addAssetSubmit'>
