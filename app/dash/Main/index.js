...
class Settings extends React.Component {
  ...
  quit() {
    return (
      <div className='addCustomTokenButtonWrap quitLightPay' style={{ zIndex: 215 }}>
        <div className='addCustomAssetBtn' onClick={() => link.send('tray:quit')}>
          Quit
        </div>
      </div>
    )
      ...
      <div className={'localSettings vaultCardShow'}>
        <div className='localSettingsWrap'>
          <div className='dashModules'>
            ...
            <div
              className='dashModule'
              onClick={() => link.send('tray:action', 'navDash', { view: 'priceAlerts', data: {} })}
            >
              <div className='dashModuleIcon'>{svg.tokens(24)}</div>
              <div className='dashModuleTitle'>{'Price Alerts'}</div>
            </div>
          </div>
          <div className='snipIt'>
            <div>Using a dapp that doesn&apos;t support LightPay natively?</div>
            <div className='snipItBrowserExtensionIcons'>
              <div
                className='extIconSnip snipItBrowserExtensionIconChrome'
                onClick={() =>
                  link.send(
                    'tray:openExternal',
              ...
              <div
                className='extIconSnip snipItBrowserExtensionIconFirefox'
                onClick={() =>
                  link.send(
                    'tray:openExternal',
                    'https://addons.mozilla.org/en-US/firefox/addon/lightpay-extension'
                  )
                }
              >
                {svg.firefox(28)}
              ...
              {/* <div 
                className='extIconSnip snipItBrowserExtensionIconSafari'
              >
                {svg.safari(28)}
              </div> */}
            </div>
          ...
          <div className='requestFeature'>
            <div
              ...
              onClick={() => {
                link.send('tray:openExternal', 'https://feedback.lightpay.tech')
              }}
            >
              Request a Feature
            </div>
