...
class Settings extends Component {
  ...
  render() {
    ...
    return (
      <div className={'localSettings vaultCardShow'}>
        <div className='localSettingsWrap'>
          <div className='devicePerm prefSetting' style={{ zIndex: 214 }}>
          ...
          <div className='devicePerm prefSetting' style={{ zIndex: 213 }}>
            <div className='signerPermissionControls'>
            ...
            <div className='signerPermissionDetails'>
              <span>Hide LightPay on loss of focus</span>
            </div>
          </div>
          <div className='devicePerm prefSetting' style={{ zIndex: 212 }}>
            <div className='signerPermissionControls'>
            ...
            <div className='signerPermissionDetails'>Run LightPay when your computer starts</div>
          </div>
          <div className='devicePerm prefSetting' style={{ zIndex: 211 }}>
            <div className='signerPermissionControls'>
            ...
            <div className='signerPermissionDetails'>{"Mouse to display's right edge to summon LightPay"}</div>
          </div>

          {this.store('platform') === 'darwin' ? (
            <div className='devicePerm prefSetting' style={{ zIndex: 210 }}>
              <div className='signerPermissionControls'>
          ...
          <div className='devicePerm prefSetting' style={{ zIndex: 209 }}>
            <div className='signerPermissionControls'>
            ...
            <div className='signerPermissionDetails'>
              <span>Help improve LightPay by anonymously reporting errors</span>
            </div>
          </div>

          <div className='devicePerm prefSetting' style={{ zIndex: 207 }}>
            <div className='signerPermissionControls'>
          ...
          <div className='devicePerm prefSetting' style={{ zIndex: 205 }}>
            <div className='signerPermissionControls'>
          ...
          <div className='devicePerm prefSetting' style={{ zIndex: 204 }}>
            <div className='signerPermissionControls'>
          ...
          {this.store('main.ledger.derivation') === 'live' ? (
            <div className='devicePerm prefSetting' style={{ zIndex: 203 }}>
              <div className='signerPermissionControls'>
          ...
          <div className='devicePerm prefSetting' style={{ zIndex: 202 }}>
            <div className='signerPermissionControls'>
          ...
          <div className='devicePerm prefSetting' style={{ zIndex: 201 }}>
            <div className='signerPermissionControls'>
          ...
          <div className='devicePerm prefSetting' style={{ zIndex: 200 }}>
            <div className='signerPermissionControls'>
            ...
            <div
              className={
                this.state.latticeEndpointMode === 'custom'
                  ? 'linkCustomInput connectionCustomInputOn'
                  : 'linkCustomInput'
              }
            >
              <input
          ...
          <div className='devicePerm prefSetting' style={{ zIndex: 199 }}>
            <div className='signerPermissionControls'>
            ...
            <div className='signerPermissionDetails'>When should LightPay relock your hot signers?</div>
          </div>
        </div>
      </div>
    )
