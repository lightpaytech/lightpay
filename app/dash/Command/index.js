...
class Command extends React.Component {
  ...
  render() {
    ...
    return (
      <div className='cmdPalette'>
        {this.store('windows.dash.nav').length ? (
          <div
            className='commandItem commandItemBack vaultCardShow'
            onClick={() => {
        ...
        <div key={view} className='commandTitle vaultCardShow'>
          {view === 'expandedSigner' ? this.renderSignerTitle() : view === 'accounts' ? 'wallets' : view}
        </div>
        <div
