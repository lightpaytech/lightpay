...
function mapToPreset(networkId, key) {
  return { text: key, value: `ethereum:${networkId}:${key}` }
}
...
const ConnectionStatus = ({ connection }) => (
  <div style={{ display: 'flex' }}>
    <ConnectionIndicator className='sliceTileIndicatorLarge lpTileIndicator' connection={connection} />
                  ...
                  <div
                    className={
                      connection.primary.on
                        ? 'devicePermToggleSmall signerPermissionToggleSmallOn'
                        : 'devicePermToggleSmall'
                    }
                    ...
                    <div
                      className={
                        connection.primary.current === 'custom' && connection.primary.on
                          ? 'linkCustomInput connectionCustomInputOn vaultCardShow'
                          : 'linkCustomInput'
                      }
                    >
                      <input
