...
export const Chain = ({
  ...
  const networkIcon = currentChainIcon === chainDefault.icon ? '' : currentChainIcon
  const updatedChain = {
    type: 'ethereum',
    id: currentChainId,
    name: currentName,
  ...
  return (
    <div key={'expandedChain'} className='network vaultCardShow'>
      ...
      <EditChainId networkId={currentChainId} onChange={setChainId} />
      ...
      <div className='networkRow networkRowRemove'>
        <SubmitChainButton
          ...
          onClick={() => {
            if (chainValidation.valid) {
              ...
              link.send('tray:addNetwork', updatedChain)
