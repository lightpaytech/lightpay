...
import Dapps from './ConnectedApps'
import Tokens from './AssetList'
...
function itemName(view) {
  if (view === 'accounts') return 'Wallet'
...
const AddNewItemButton = ({ view, req }) => {
  const dataMap = {
    ...
    chains: { newChain: {} },
    tokens: { notify: 'addAsset', notifyData: req }
  }
...
class Dash extends React.Component {
  ...
  renderPanel(view, data) {
    ...
    if (view === 'priceAlerts') return <PriceAlerts data={data} />
