...
export default {
    ...
    return (
      <div style={{ width: size + 'px', height: size + 'px' }}>
        <svg viewBox='0 0 24 24'>
          <path
            fill='currentColor'
            d='M14 2 L4 14 L11 14 L10 22 L20 10 L13 10 L14 2 Z'
          />
        </svg>
      </div>
    )
    ...
    return (
      <div style={{ width: size + 'px', height: size + 'px' }}>
        <svg viewBox='0 0 24 24' width={size + 'px'} height={size + 'px'}>
          <path
            fill='currentColor'
            d='M13 17.5a1 1 0 11-2 0 1 1 0 012 0zm-.25-8.5a.75.75 0 00-1.5 0v4.5a.75.75 0 001.5 0v-4.5z'
          />
          <path
            fill='currentColor'
            d='M9.836 3.244c.963-1.665 3.365-1.665 4.328 0l8.967 15.504c.963 1.667-.24 3.752-2.165 3.752H3.034c-1.926 0-3.128-2.085-2.165-3.752L9.836 3.244zm3.03.751a1 1 0 00-1.732 0L2.168 19.5A1 1 0 003.034 21h17.932a1 1 0 00.866-1.5L12.866 3.994z'
          />
        </svg>
      </div>
    )
    ...
    return (
      <div style={{ width: size + 'px', height: size + 'px' }}>
        <svg viewBox='0 0 24 24' width={size + 'px'} height={size + 'px'}>
          <path
            fill='currentColor'
            d='M18.78 15.28a.75.75 0 000-1.06l-6.25-6.25a.75.75 0 00-1.06 0l-6.25 6.25a.75.75 0 101.06 1.06L12 9.57l5.72 5.72a.75.75 0 001.06 0z'
          />
        </svg>
      </div>
    )
    ...
    return (
      <div style={{ width: size + 'px', height: size + 'px' }}>
        <svg viewBox='0 0 24 24' width={size + 'px'} height={size + 'px'}>
          <path
            fill='currentColor'
            d='M3.5 3.75a.25.25 0 01.25-.25h13.5a.25.25 0 01.25.25v10.25a.75.75 0 001.5 0v-10.25A1.75 1.75 0 0017.25 2H3.75A1.75 1.75 0 002 3.75v16.5c0 .966.784 1.75 1.75 1.75h7a.75.75 0 000-1.5h-7a.25.25 0 01-.25-.25V3.75z'
          />
          <path
            fill='currentColor'
    ...
    return (
      <div style={{ width: size + 'px', height: size + 'px' }}>
        <svg viewBox='0 0 24 24' width={size + 'px'} height={size + 'px'}>
          <path
            fill='currentColor'
            d='M5.873 3.26A.75.75 0 016.44 3h11.31a.75.75 0 01.576.27l5 6a.75.75 0 01-.028.992l-10.75 11.5a.75.75 0 01-1.096 0l-10.75-11.5a.75.75 0 01-.02-1.003l5.19-6zm.91 1.24L2.258 9.73 12 20.154l9.75-10.43L17.399 4.5H6.783z'
          />
        </svg>
      </div>
    )
    ...
    return (
      <div style={{ width: size + 'px', height: size + 'px' }}>
        <svg viewBox='0 0 24 24' width={size + 'px'} height={size + 'px'}>
          <path
            fill='currentColor'
            d='M15 18a1 1 0 100-2 1 1 0 000 2zm1-6a1 1 0 11-2 0 1 1 0 012 0zm-7 6a1 1 0 100-2 1 1 0 000 2zm0-5a1 1 0 100-2 1 1 0 000 2zm7-6a1 1 0 11-2 0 1 1 0 012 0zM9 8.25a1 1 0 100-2 1 1 0 000 2z'
          />
        </svg>
      </div>
    )
      ...
      <div style={{ width: size + 'px', height: size + 'px' }}>
        <svg viewBox='0 0 24 24' width={size + 'px'} height={size + 'px'}>
          <path
            fill='currentColor'
            fillRule='evenodd'
            d='M8.854 11.646l5.792-5.792a.5.5 0 01.854.354v11.586a.5.5 0 01-.854.354l-5.792-5.792a.5.5 0 010-.708z'
          />
        </svg>
      </div>
    )
      ...
      <div style={{ width: size + 'px', height: size + 'px' }}>
        <svg viewBox='0 0 352 512' width={size + 'px'} height={size + 'px'}>
          <path
            fill='currentColor'
            fillRule='evenodd'
            d='M242.72 256l100.07-100.07c12.28-12.28 12.28-32.19 0-44.48l-22.24-22.24c-12.28-12.28-32.19-12.28-44.48 0L176 189.28 75.93 89.21c-12.28-12.28-32.19-12.28-44.48 0L9.21 111.45c-12.28 12.28-12.28 32.19 0 44.48L109.28 256 9.21 356.07c-12.28 12.28-12.28 32.19 0 44.48l22.24 22.24c12.28 12.28 32.2 12.28 44.48 0L176 322.72l100.07 100.07c12.28 12.28 32.2 12.28 44.48 0l22.24-22.25c12.28-12.28 12.28-32.19 0-44.48L242.72 256z'
          />
        </svg>
      </div>
    )
    ...
    return (
      <div style={{ width: size + 'px', height: size + 'px' }}>
        <svg viewBox='0 0 24 24' width={size + 'px'} height={size + 'px'}>
          <path
            fill='currentColor'
            d='M3.75 5.5a.75.75 0 000 1.5h10a.75.75 0 000-1.5h-10zm5 6a.75.75 0 000 1.5h11.5a.75.75 0 000-1.5H8.75zm0 6a.75.75 0 000 1.5h11.5a.75.75 0 000-1.5H8.75zM5 12a1 1 0 11-2 0 1 1 0 012 0zm-1 7.25a1 1 0 100-2 1 1 0 000 2z'
          />
          <path
            fill='currentColor'
      ...
      <div style={{ width: size + 'px', height: size + 'px' }}>
        <svg viewBox='0 0 16 16' width={size + 'px'} height={size + 'px'}>
          <path
            fillRule='evenodd'
            fill='currentColor'
            d='M8.878.392a1.75 1.75 0 00-1.756 0l-5.25 3.045A1.75 1.75 0 001 4.951v6.098c0 .624.332 1.2.872 1.514l5.25 3.045a1.75 1.75 0 001.756 0l5.25-3.045c.54-.313.872-.89.872-1.514V4.951c0-.624-.332-1.2-.872-1.514L8.878.392zM7.875 1.69a.25.25 0 01.25 0l4.63 2.685L8 7.134 3.245 4.375l4.63-2.685zM2.5 5.677v5.372c0 .09.047.171.125.216l4.625 2.683V8.432L2.5 5.677zm6.25 8.271l4.625-2.683a.25.25 0 00.125-.216V5.677L8.75 8.432v5.516z'
          />
        </svg>
      </div>
    )
  ...
  // New VAULT design icons not in LightPay
  vault: (size = 16) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 16 16" fill="none">
      <rect x="2" y="3" width="12" height="10" rx="2.5" stroke="currentColor" strokeWidth="1.75"/>
      <circle cx="8" cy="8" r="2.5" stroke="currentColor" strokeWidth="1.5"/>
      <circle cx="8" cy="8" r="1" fill="currentColor"/>
      <line x1="8" y1="5.5" x2="8" y2="4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <line x1="8" y1="12" x2="8" y2="10.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <line x1="5.5" y1="8" x2="4" y2="8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <line x1="12" y1="8" x2="10.5" y2="8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  ),
  ...
  shieldCheck: (size = 16) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 16 16" fill="none">
      <path d="M8 2L3 4.5V8.5C3 11.5 5.5 13.5 8 14C10.5 13.5 13 11.5 13 8.5V4.5L8 2Z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"/>
  ...
  walletIcon: (size = 16) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 16 16" fill="none">
      ...
      <path d="M10 4V3C10 2.44772 9.55228 2 9 2H7C6.44772 2 6 2.44772 6 3V4" stroke="currentColor" strokeWidth="1.5"/>
  ...
  linkOut: (size = 12) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 12 12" fill="none">
      <path d="M5 2.5H2.5C2.22386 2.5 2 2.72386 2 3V9.5C2 9.77614 2.22386 10 2.5 10H9C9.27614 10 9.5 9.77614 9.5 9.5V7" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round"/>
      <path d="M7 2H10M10 2V5M10 2L5.5 6.5" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  ),
  ...
  gasIcon: (size = 14) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 14 14" fill="none">
      <path d="M3 12V3.5C3 3.22386 3.22386 3 3.5 3H8.5C8.77614 3 9 3.22386 9 3.5V7.5L11 9V11.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M3 12H11" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M5 6H7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  ),
  ...
  bell: (size = 16) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 16 16" fill="none">
      <path d="M8 2C5.79 2 4 3.79 4 6V10L2.5 11.5V12H13.5V11.5L12 10V6C12 3.79 10.21 2 8 2Z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"/>
      <path d="M6.5 12.5C6.5 13.33 7.17 14 8 14C8.83 14 9.5 13.33 9.5 12.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  ),

  chartLine: (size = 16) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 16 16" fill="none">
      <path d="M2 12L5.5 7.5L8.5 9.5L12 5L14 6.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M2 14H14" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" opacity="0.4"/>
    </svg>
  ),

  portfolio: (size = 16) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 16 16" fill="none">
      <rect x="2" y="6" width="3" height="8" rx="1" fill="currentColor" opacity="0.4"/>
      <rect x="6.5" y="4" width="3" height="10" rx="1" fill="currentColor" opacity="0.6"/>
