      ...
      >
        <div className='dataGroupAddr'>
          <span className='dataGroupAddrTo'>
            {name ? (
              <span className='dataGroupAddrTo' style={{ fontFamily: 'MainFont', fontWeight: '400' }}>
                {name}
              </span>
            ) : (
              <>
...
const Description = ({ isRevoke }) => (
  <ClusterRow>
    <ClusterValue>
      <div className='dataGroupTag' style={{ color: 'var(--moon)' }}>
    ...
    <div className='updateTokenApproval'>
      <ClusterBox title={'token approval details'} style={{ marginTop: '64px' }}>
        ...
        <Cluster style={{ marginTop: '16px' }}>
          <ClusterRow>
            <ClusterValue>
              <div className='permitSpendLabel'>{symbol}</div>
            </ClusterValue>
          </ClusterRow>
          <ClusterRow>
            <ClusterValue transparent={true} pointerEvents={'auto'}>
              <div className='permitSpendAmount'>
          ...
          <ClusterRow>
            <ClusterValue transparent={true}>
              <div className='permitSpendSubtitle'>Set Token Approval Spend Limit</div>
            </ClusterValue>
          </ClusterRow>
          <ClusterRow>
          ...
          {!inputLock && (
            <ClusterRow>
              ...
              >
                <div className={'dataGroupTag'} style={isCustom ? { color: 'var(--good)' } : {}} role='button'>
                  Custom
                </div>
              </ClusterValue>
            </ClusterRow>
